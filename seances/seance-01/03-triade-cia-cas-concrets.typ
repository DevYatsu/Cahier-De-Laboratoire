...
- *Banque en ligne (4/4/4) :* le secret bancaire (loi) et l'exactitude des soldes priment (C et I au maximum), et l'accès au service doit être continu (A au maximum), règle FINMA; sans les lois et les règles FINMA, cela serait certainement l'intégrité (la confiance envers la banque) qui primerait.
...
Notion de règles impératives (exemple: banque).
