...
Le matin pose les fondations : auto-évaluation chiffrée (exercices 1), triade CIA et critères secondaires (exercices 2 et 3), puis secteurs et échelles d'application (exercice 4). L'après-midi resserre sur la pratique : positionnement DevSecOps via CI/CD et roadmap (activité 1) et facteur humain avec six familles de biais et leurs mitigations (activité 4). Le travail personnel décortique ISO 27001 : périmètre SMSI, risques top-down, SoA et cycle PDCA. L'activité 3 traite de la veille OSINT autorisée, du recensement de serveurs WordPress et du recul sur les protections.

#include "01-auto-evaluation-initiale.typ"
#include "02-criteres-principaux-secondaires.typ"
#include "03-triade-cia-cas-concrets.typ"
#include "04-secteurs-domaines-application.typ"
#include "05-facteur-humain-biais-cognitifs.typ"
#include "06-competences-devsecops.typ"
#include "07-protection-wordpress-ricardo.typ"
#include "08-recommandations-organismes.typ"
#include "09-vocabulaire-cybersecurite.typ"
#include "10-role-responsable-securite.typ"
#include "11-surface-attaque-kernel-linux.typ"
#include "12-travail-personnel-iso-27001.typ"
#include "13-synthese-seance.typ"
